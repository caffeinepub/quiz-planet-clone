...
export interface _SERVICE {
  ...
  'answerQuestion' : ActorMethod<[string, bigint], boolean>,
  ...
  'getPlayerScore' : ActorMethod<[string], bigint>,
  'getQuestion' : ActorMethod<[string], Question>,
  'isGameFinished' : ActorMethod<[string], boolean>,
  'startNewGame' : ActorMethod<[string], undefined>,
}
