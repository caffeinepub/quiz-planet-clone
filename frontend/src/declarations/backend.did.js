...
export const idlService = IDL.Service({
  ...
  'answerQuestion' : IDL.Func([IDL.Text, IDL.Nat], [IDL.Bool], []),
  ...
  'getPlayerScore' : IDL.Func([IDL.Text], [IDL.Nat], ['query']),
  'getQuestion' : IDL.Func([IDL.Text], [Question], ['query']),
  'isGameFinished' : IDL.Func([IDL.Text], [IDL.Bool], ['query']),
  'startNewGame' : IDL.Func([IDL.Text], [], []),
});
