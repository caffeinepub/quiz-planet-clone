...
export class Backend implements backendInterface {
    ...
    async answerQuestion(arg0: string, arg1: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getPlayerScore(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getPlayerScore(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isGameFinished(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isGameFinished(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async startNewGame(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.startNewGame(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
